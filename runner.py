...
def run_executable_with_concurrent_touches(executable: str, duration: int = 10):
    ...
    Args:
        ...
        duration: Duration parameter to pass to executable (-d flag)
    """
    nproc = multiprocessing.cpu_count()
    print(f"\n{'='*60}")
    print(f"Running: {executable} -d {duration}")
    ...
    # Wait for executable to complete
